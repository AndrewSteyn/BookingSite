      ...
      <div class="container-fluid">
            ...
            <div class="container heading-container">         
              ...
              <center>
                <div class="homeButtons">
                  <a href="#roomsSection"><button type="submit">Veiw Rooms</button></a>
                  <a href="#bookingSection"><button type="submit">Make Booking</button></a>
                </div>
              </center>
            </div>
          </div>
        ...
        <div id="roomsSection">
          <div class="jumbotron jumbotron-fluid" id="roomsSection">
            ...
            <!--Book Now Button-->
            <center>
              <!-- <button type="submit" name="submit">Compare Hotels</button> -->
        ...
        <div id="bookingSection">
          <div class="jumbotron jumbotron-fluid" id="bookingSection">
            <div class="container">
              ...
              <center>
                <form class="userdetails" role="form" method="POST" method="post" action="<?php echo htmlspecialchars($_SERVER["PHP_SELF"]); ?>">
